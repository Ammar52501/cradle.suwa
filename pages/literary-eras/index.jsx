...
const LiteraryEras = ({ erasAllEras, translations }) => {
  ...
  return (
    <>
      <Head>
        <title>{translations.historicalLiteraryEras}</title>
        <meta charset="UTF-8" />
          ...
          <motion.div
            ...
            <div className={styles.imags_container}>
              <div className={styles.right_branch}>
                <img src={"/assets/imgs/right_branch.webp"} objectFit='contain' alt='' />

              </div>
              <div className={styles.left_branch}>
                <img src={"/assets/imgs/left_branch.webp"} objectFit='contain' alt='' />

              </div>
              <div className={styles.horse}>
                <img src={"/assets/imgs/horse.webp"} objectFit='contain' alt='' />
